...
public class Client {
    ...
    public static void main(String args[]) throws Exception
    {
        ...
        // Convert input String to bytes using the defaultcharset
...
// Initiate connection to server and repeatedly polluntil complete
        if (!clntChan.connect(new InetSocketAddress(server,
                servPort))) {
